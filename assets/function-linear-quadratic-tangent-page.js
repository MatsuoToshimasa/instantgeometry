(function () {
  ...
  if (!stage || !coefA || !coefB || !constC || !tangentT) return;
  ...
  function tangentLine(a, b, c, t) {
    const slope = 2 * a * t + b;
    return {
      slope: slope,
      intercept: c - a * t * t,
      touch: point(t, a * t * t + b * t + c)
    };
  }
  ...
  function render() {
    ...
    try {
      ...
      c = parseConstantC();
      t = parseTangentT();
      const tangent = tangentLine(a, b, c, t);
  ...
  function saveImage(format) {
    ...
    return captureCanvas(transparent ? null : '#ffffff').then(function (canvas) {
      ...
      link.download = transparent ? 'function-linear-quadratic-tangent-transparent.png' : 'function-linear-quadratic-tangent.png';
  ...
  function savePdf() {
    ...
    return captureCanvas('#ffffff').then(function (canvas) {
      ...
      pdf.save('function-linear-quadratic-tangent.pdf');
    });
  }
