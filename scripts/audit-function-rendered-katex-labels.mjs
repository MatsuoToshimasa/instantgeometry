...
const PAGE_HARD_TIMEOUT_MS = Math.max(PAGE_TIMEOUT_MS + ACTION_TIMEOUT_MS, Number(process.env.KATEX_LABEL_AUDIT_HARD_TIMEOUT_MS || 25000));
const RENDER_SETTLE_MS = Math.max(0, Number(process.env.KATEX_LABEL_AUDIT_RENDER_SETTLE_MS || 650));
